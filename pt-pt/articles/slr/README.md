...
Artigos selecionados sobre condução de revisões sistemáticas da literatura em Ciência da Computação.
...
- **PRISMA_2020_checklist.docx** — Checklist para relato
- **PRISMA_2020_flow_diagram_new_SRs_v1.docx** — Modelo de fluxograma
- **PRISMA App.url** — Link para ferramenta PRISMA interativa
